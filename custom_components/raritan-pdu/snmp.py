...
class SNMPManager:
    ...
    # async def snmp_get(self, *oid: any) -> any:
    #     _LOGGER.debug(f"SNMP get: {self.host}:{self.port} {self.community} {oid}")
    #
    ...
    #     )
    #
    #     _LOGGER.debug(f"SNMP get: {self.host}:{self.port} {self.community} {oid}", errorIndication, errorStatus,
    #                   errorIndex, varBinds)
    #
    #     if errorIndication:
